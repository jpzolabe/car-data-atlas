...
**Parked, 2026-09-12** (sous-préfecture pages explicitly deferred, not
worth doing until more themes reach that level):

1. ~~National comparison on place pages~~ - **done 2026-09-12.** Each
